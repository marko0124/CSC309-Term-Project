      ...
      <div className="detail-popup">
        <div className="detail-popup-inner">
          ...
          <div id="detail-popup-buttons">
            ...
            {!promotion.loading && (
              <button className="popup-btn submit-btn" onClick={onEdit}>Edit Promotion</button>
            )}
            <button className="popup-btn submit-btn" onClick={onDelete}>Delete Promotion</button>
          </div>
        </div>
      </div>
    </>
